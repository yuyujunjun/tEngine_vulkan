                    ...
                    const ccd_t *ccd, ccd_simplex_t *simplex)
{
    ...
    __tccdSupport(obj1, obj2,*ccd, &dir,  &last);
                              ...
                              ccd_pt_t *pt, ccd_pt_el_t **nearest)
{
    ...
    for (i = 0; i < ccd_points_on_sphere_len; i++){
        __tccdSupport(obj1, obj2, *ccd, &ccd_points_on_sphere[i], &supp[0]);
    ...
    ccdVec3Scale(&dir, -CCD_ONE);
    __tccdSupport(obj1, obj2, *ccd, &dir, &supp[1]);
                       ...
                       ccd_support_t *out)
{
    ...
    __tccdSupport(obj1, obj2, *ccd, &el->witness,out);
