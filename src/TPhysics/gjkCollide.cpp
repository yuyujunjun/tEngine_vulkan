...
void __tccdSupport(const void* _obj1, const void* _obj2,const ccd_vec3_t* dir, ccd_support_t* supp) {
   ...
   const GJKSupportObj* obj1 = static_cast<const GJKSupportObj*>(_obj1);
   const GJKSupportObj* obj2 = static_cast<const GJKSupportObj*>(_obj2);
    
   auto sup1=obj1->system->SupportPoint(obj1->id,tEngine::Vector3(dir->v[0], dir->v[1], dir->v[2]));
   supp->v1.v[0] = sup1[0]; supp->v1.v[1] = sup1[1]; supp->v1.v[2] = sup1[2];
   auto sup2=obj2->system->SupportPoint(obj2->id,tEngine::Vector3(-dir->v[0], -dir->v[1], -dir->v[2]));
