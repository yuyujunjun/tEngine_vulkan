  ...
  namespace su
  {
    ...
    struct TextureData
    {
                     ...
                     ImageGenerator const &    imageGenerator )
      {
        ...
        if ( needsStaging )
        {
          // Since we're going to blit to the texture vkImage, set its layout to eTransferDstOptimal
          ...
          // Set the layout for the texture vkImage from eTransferDstOptimal to SHADER_READ_ONLY
          vk::su::setImageLayout( commandBuffer,
                                  imageData->image,
                                  imageData->format,
                                  vk::ImageLayout::eTransferDstOptimal,
        ...
        {
          // If we can use the linear tiled vkImage as a texture, just do it
          vk::su::setImageLayout( commandBuffer,
                                  imageData->image,
                                  imageData->format,
