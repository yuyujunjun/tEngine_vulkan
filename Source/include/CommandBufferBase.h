...
namespace tEngine {
	...
	public:
		...
		void bindDescriptorSet(vk::PipelineBindPoint bindingPoint, const tPipelineLayout::SharedPtr& pipelineLayout, uint32_t firstSet, const std::vector<DescriptorSetHandle>& sets,
